  ...
  ;
    ...
    Polymer('pulsing-circle',{
      ...
      ready: function() {
        ...
        var circle = this.shadowRoot.querySelector('.circle');
        circle.animate([
          {opacity: "1.0", transform: "scale(5)"},
          {opacity: ".9", transform: "scale(10)"},
          {opacity: ".8", transform: "scale(10)"},
